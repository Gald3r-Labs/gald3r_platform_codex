...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for Codex CLI** -- file-based
...
Open this project in **Codex CLI** and run **`@g-setup`** -- it initializes gald3r and fills in
